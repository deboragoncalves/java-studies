...
public class Exercicio59 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite o número de habitantes de uma cidade: ");
		...
		for (int i = 1; i <= habitantes; i++) {
			System.out.println(i + " - Digite o consumo do mês: ");
			int consumo = teclado.nextInt();
			somaConsumo += consumo;
			listaConsumo.add(consumo);
			
			System.out.println(i + " - Digite o código do consumidor: ");
		...
		System.out.println("O menor consumo é de " + listaConsumo.get(0));
		System.out.println("O maior consumo é de " + listaConsumo.get(habitantes - 1));
		
		double media = somaConsumo / habitantes;
		System.out.println("A média de consumo é de " + media);

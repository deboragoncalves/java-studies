...
// Não utilizei muito OO.
// Sistema que pergunta ao usuário se ele já é cliente Motoboy (dentro do if, colocar as opções para Sim, S, etc)
// Se não, em quantos estados ele deseja ser atendido. Essa variável será String e depois convertida para inteiro.
// Try/catch para a situação em que o usuário digitou Dois, digitou String ou número.
// Enquanto o número for menor que i, o for vai perguntando quais os estados e avaliando se a Motoboy está presente.
// Quando usuário digita, como o switch ou if está analisando a condição quando é com letras maiúsculas, utilizar o método 
// ToUpperCase() caso seja minúscula.
// Dentro do if dos estados, tem a opção se o usuário digitou SP ou São Paulo.

...
public class Exercicio70 {
	...
	public static String divisao(int numerador, int denominador) {
		...
		System.out.println();
		System.out.print("Divis�o entre " + numerador + " e " + denominador + ": ");
	...
	public static String negativo(int numerador, int denominador) {
		...
		System.out.println();
		System.out.print("N�mero Negativo (" + divisao + "): ");
	...
	public static String multiplicacao(double numero1, double numero2) {
		...
		System.out.println();
		System.out.print("Multiplica��o de " + formatacaoDecimal.format(numero1) + " e " + formatacaoDecimal.format(numero2) + ": ");
	...
	public static String divisao(double numero1, double numero2) {
		...
		System.out.println();
		System.out.print("Divis�o de " + formatacaoDecimal.format(numero2) + " e " + formatacaoDecimal.format(numero1) + ": ");
		return formatacaoDecimal.format(divisao);
	}

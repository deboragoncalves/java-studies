...
public class Exercicio24 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			System.out.println("Digite o n�mero do aluno " + (i + 1));
		...
		System.out.println("N�mero do aluno mais baixo: " + numeroAlunos[0]);
		System.out.println("Altura do aluno mais baixo: " + alturaAlunos[0]);
		System.out.println();
		System.out.println("N�mero do aluno mais alto: " + numeroAlunos[numeroAlunos.length-1]);

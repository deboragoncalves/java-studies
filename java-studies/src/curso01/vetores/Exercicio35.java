...
public class Exercicio35 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite um n�mero inteiro entre 0 e 10.000: ");
		int a = teclado.nextInt();

		System.out.println("Digite um outro n�mero inteiro entre 0 e 10.000: ");
		...
		if (a > 0 && a < 10000) {
			...
			System.out.println("N�o foi poss�vel calcular o vetor A. Os valores informados n�o est�o dentro do intervalo requerido (0 e 10.000).");
			return;
		}
		...
		if (b > 0 && b < 10000) {
			...
			System.out.println("N�o foi poss�vel calcular o vetor B. Os valores informados n�o est�o dentro do intervalo requerido (0 e 10.000).");
			return;
		}

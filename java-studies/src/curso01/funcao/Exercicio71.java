...
public class Exercicio71 {
	...
	public static int dentroRetangulo(int coordX, int coordY) {
		...
		System.out.println();
		System.out.println("Coordenadas Ret�ngulo: ");
		...
		if (coordenadasX.contains(coordX) && coordenadasY.contains(coordY)) {
			System.out.print("O ponto (" + coordX + ", " + coordY + ") pertence ao Ret�ngulo: " );
			return 1;
		} else {
			System.out.print("O ponto (" + coordX + ", " + coordY + ") n�o pertence ao Ret�ngulo: " );
			return 0;
		}
